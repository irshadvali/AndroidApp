...
import com.irshad.uiretrofitapp.adapter.CommentsAdapter;
...
public class CommentsFrg extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView=inflater.inflate(R.layout.comments_tab, container, false);
        recyclerView = (RecyclerView) rootView.findViewById(R.id.recycler_view);
        preparefullData();
        mAdapter = new CommentsAdapter(getActivity(),fulldatalist);
